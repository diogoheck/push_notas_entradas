...
def limpar_conteudo_pasta():
    for arquivo in os.listdir('R:\\Compartilhado\\Push\\xmls_temp'):
        if os.path.isfile('R:\\Compartilhado\\Push\\xmls_temp' + os.sep + arquivo):
            os.remove('R:\\Compartilhado\\Push\\xmls_temp' + os.sep + arquivo)
